...
# cluster contains rho-values building a cluster
    ...
    # Abstand auf der Linie berechnen
    distance = 0
    distances = []
    ...
    for cc_i in range(len(string)):
        ...
        # check edge to edge distance against the local character gap threshold
...
#                print "Strings ", string
    ...
    floatImage.save_PNG(r"/home/pragma/workspace/svn_dia-tss/houghDomain.png")
#    onebit0.save_PNG(r"/home/pragma/workspace/svn_dia-tss/out.png")
    image0.save_PNG(r"/home/pragma/workspace/svn_dia-tss/out2.png")
